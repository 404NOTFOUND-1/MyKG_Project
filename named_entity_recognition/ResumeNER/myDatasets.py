...
name = '动力电池'
raw_file = '{}/all.jsonl'.format(name)
temp = 'temp/'
conv_file = name + '/doccano_conv.json'


def get_parser():
    parser = argparse.ArgumentParser()
    parser.add_argument('--temp', type=str, default='temp/', help='temp文件夹目录')
    parser.add_argument('--split_raw_jsonl', type=str, default='动力电池/all.jsonl',
